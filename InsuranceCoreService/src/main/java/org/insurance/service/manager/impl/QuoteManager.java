...
public class QuoteManager extends ServiceCore implements IQuoteManager {
	...
	@Inject
	private IQuoteCheck quoteCheck;

	@Override
	public int insertQuote(long numcli, String cuser, Cli_quote cliQuote) throws InsuranceException {
		/*cliQuote.getCbranch();
		cliQuote.getCcategory();
		cliQuote.getCduration();
		cliQuote.getCquotestatus();
		cliQuote.getCuseruw();
		cliQuote.getEndval(); && cliQuote.getStartval();
		cliQuote.getGuaranteedamount();
		cliQuote.getNumcli();
		cliQuote.getNumclibroker();
		cliQuote.getNumclileader();
		cliQuote.getNumcon();
		cliQuote.getPremiumamount()
		cliQuote.getSharepart();*/
