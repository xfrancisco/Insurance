...
public class PopulationService implements IPopulationService {
	...
	@Override
	public List<PersonOut> getPopulations(final String userId, PopulationIn populationIn, final String name) throws MfcException {
	...
	@Override
	public List<PersonOut> getClients(final String userId) throws MfcException {
		userCheck.checkUser(userId);
		return PersonMapping.populatePersonOut(populationInfo.getClients());
	}

	@Override
	public List<PersonOut> getBrokers(final String userId) throws MfcException {
		userCheck.checkUser(userId);
		return PersonMapping.populatePersonOut(populationInfo.getBrokers());
	}

	@Override
	public List<PersonOut> getInsurers(final String userId) throws MfcException {
		userCheck.checkUser(userId);
		return PersonMapping.populatePersonOut(populationInfo.getInsurers());
	}

	@Override
	public List<PersonOut> getReinsurers(final String userId) throws MfcException {
		userCheck.checkUser(userId);
		return PersonMapping.populatePersonOut(populationInfo.getReinsurers());
	}

	@Override
	public List<PersonOut> getExperts(final String userId) throws MfcException {
		userCheck.checkUser(userId);
		return PersonMapping.populatePersonOut(populationInfo.getExperts());
	}

	@Override
	public List<PersonOut> getLawyers(final String userId) throws MfcException {
		userCheck.checkUser(userId);
		return PersonMapping.populatePersonOut(populationInfo.getLawyers());
	}

	@Override
	public List<PersonOut> getBeneficiaries(final String userId) throws MfcException {
		userCheck.checkUser(userId);
		return PersonMapping.populatePersonOut(populationInfo.getBeneficiaries());
	}

	@Override
	public List<PersonOut> getThirdParties(final String userId) throws MfcException {
		userCheck.checkUser(userId);
		return PersonMapping.populatePersonOut(populationInfo.getThirdParties());
	}

	@Override
	public List<PersonOut> getAgencies(final String userId) throws MfcException {
		userCheck.checkUser(userId);
		return PersonMapping.populatePersonOut(populationInfo.getAgencies());
	}

	@Override
	public List<PersonOut> getClientsByName(final String userId, final String name) throws MfcException {
		userCheck.checkUser(userId);
		if (Strings.isNullOrEmpty(name))
	...
	@Override
	public List<PersonOut> getBrokersByName(final String userId, final String name) throws MfcException {
		userCheck.checkUser(userId);
		if (Strings.isNullOrEmpty(name))
	...
	@Override
	public List<PersonOut> getInsurersbyName(final String userId, final String name) throws MfcException {
		userCheck.checkUser(userId);
		if (Strings.isNullOrEmpty(name))
	...
	@Override
	public List<PersonOut> getReinsurersByName(final String userId, final String name) throws MfcException {
		userCheck.checkUser(userId);
		if (Strings.isNullOrEmpty(name))
	...
	@Override
	public List<PersonOut> getExpertsByName(final String userId, final String name) throws MfcException {
		userCheck.checkUser(userId);
		if (Strings.isNullOrEmpty(name))
	...
	@Override
	public List<PersonOut> getLawyersByName(final String userId, final String name) throws MfcException {
		userCheck.checkUser(userId);
		if (Strings.isNullOrEmpty(name))
	...
	@Override
	public List<PersonOut> getBeneficiariesByName(final String userId, final String name) throws MfcException {
		userCheck.checkUser(userId);
		if (Strings.isNullOrEmpty(name))
	...
	@Override
	public List<PersonOut> getThirdPartiesByName(final String userId, final String name) throws MfcException {
		userCheck.checkUser(userId);
		if (Strings.isNullOrEmpty(name))
	...
	@Override
	public List<PersonOut> getAgenciesByName(final String userId, final String name) throws MfcException {
		userCheck.checkUser(userId);
		if (Strings.isNullOrEmpty(name))
	...
	@Override
	public List<PersonOut> getAll(final String userId) throws MfcException {
		userCheck.checkUser(userId);
		return PersonMapping.populatePersonOut(populationInfo.getAll());
	}

	@Override
	public List<PersonOut> getAllByName(final String userId, final String name) throws MfcException {
		userCheck.checkUser(userId);
