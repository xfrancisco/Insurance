...
select * from all_tables where owner = 'WEBUSER';
...
alter table CLI_CLIENT ADD CONSTRAINT FK_CLIENTCATCLI FOREIGN KEY (CCATCLI) REFERENCES COD_CATCLI(CCATCLI);
...
INSERT INTO COD_CATCLI(CCATCLI, LCATCLI, INDCLIENT, INDVALI) values ('CLI', 'CLIENT', '1', '1');

INSERT INTO USR_ROLE(CROLE, LROLE, INDVALI) VALUES ('ADMIN', 'ADMINISTRATEUR MFR', '1');
