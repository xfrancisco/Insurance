...
select * from all_objects where object_name = 'FK_CONTRACTUSERCANCEL';
...
INSERT INTO COD_MOVEMENTDET(CCOLUMN, LABEL, VALUETABLE, VALUECOLUMN) VALUES ('CCATEGORY', 'CATÉGORIE', 'COD_CATEGORY', 'LCATEGORY');
INSERT INTO COD_MOVEMENTDET(CCOLUMN, LABEL, VALUETABLE, VALUECOLUMN) VALUES ('CDURATION', 'DURÉE', 'COD_DURATION', 'LDURATION');
...
INSERT INTO COD_MOVEMENTDET(CCOLUMN, LABEL, VALUETABLE, VALUECOLUMN) VALUES ('ENDVAL', 'FIN DE VALIDITÉ', NULL, NULL);
...
INSERT INTO COD_MOVEMENTDET(CCOLUMN, LABEL, VALUETABLE, VALUECOLUMN) VALUES ('NUMCLILEADER', 'APÉRITEUR', NULL, NULL);
