...
CREATE TABLE CPT_GUARBROKER
( 
  NUMGUARBROKER NUMBER(8) NOT NULL,
  NUMGUARANTEE NUMBER(8) NOT NULL,
  NUMCLIBRO NUMBER(8) NOT NULL,
  RATE NUMBER(16,3) NOT NULL,
  CUSERCRE VARCHAR2(32) NOT NULL,
  CREATIONDATE DATE NOT NULL,
  CUSERMOD VARCHAR2(32),
  MODIFDATE DATE,
  CONSTRAINT CPTGUARBROKER_PK PRIMARY KEY (NUMGUARBROKER)
);

alter table CPT_GUARBROKER ADD CONSTRAINT FK_GUARBROKERGUAR FOREIGN KEY (NUMGUARANTEE) REFERENCES CLI_GUARANTEE(NUMGUARANTEE);
alter table CPT_GUARBROKER ADD CONSTRAINT FK_GUARBROKERBRO FOREIGN KEY (NUMCLIBRO) REFERENCES CLI_CLIENT(NUMCLI);

CREATE SEQUENCE NUMGUARBROKER_SEQ
START WITH     1
INCREMENT BY   1
NOCACHE
NOCYCLE;
...
CREATE TABLE COD_TABLEDET
( 
  NUMTABLEDET NUMBER(8),
  CTABLE VARCHAR2(32) NOT NULL,
  COLUMNNAME VARCHAR2(128) NOT NULL,
  ATTRIBUTENAME VARCHAR2(128) NOT NULL,
  COLUMNLABEL VARCHAR2(128) NOT NULL,
  INDVALI VARCHAR2(1) DEFAULT '1' NOT NULL,
  CONSTRAINT CODTABLEDET_PK PRIMARY KEY (NUMTABLEDET)
);

alter table COD_TABLEDET ADD CONSTRAINT FK_TABLEDETTABLE FOREIGN KEY (CTABLE) REFERENCES COD_TABLE(CTABLE);

comment on table COD_TABLEDET is 'Table des codes tables standards (listes de valeurs cle/valeur sans indicateurs supplementaires)';
comment on column COD_TABLEDET.NUMTABLEDET is 'Cle primaire fictive';
comment on column COD_TABLEDET.CTABLE is 'Nom de la table';
comment on column COD_TABLEDET.COLUMNNAME is 'Nom de la colonne en base';
comment on column COD_TABLEDET.ATTRIBUTENAME is 'Nom de l''attribut';
comment on column COD_TABLEDET.COLUMNLABEL is 'Libelle';
comment on column COD_TABLEDET.INDVALI is 'Identifiant de validite. Si a 1 alors valide';

insert into COD_TABLEDET(NUMTABLEDET, CTABLE, COLUMNNAME, ATTRIBUTENAME, COLUMNLABEL, INDVALI)
values (1, 'FREQUENCIES', 'NBMONTHS', 'nbmonths', 'Nombre de mois', '1');


--

drop table CPT_BILL cascade constraint ;

CREATE TABLE CPT_BILL
( 
  NUMBILL NUMBER(8) NOT NULL,
  NUMCLI NUMBER(8) NOT NULL,
  ...
  CUSERMOD VARCHAR2(32),
  MODIFDATE DATE,
  CONSTRAINT CPTBILL_PK PRIMARY KEY (NUMBILL)
);

CREATE SEQUENCE NUMBILL_SEQ
START WITH     1
INCREMENT BY   1
NOCACHE
NOCYCLE;

drop table CPT_BILLLEADER cascade constraint ;

CREATE TABLE CPT_BILLLEADER
( 
  NUMBILLLEADER NUMBER(8) NOT NULL,
  NUMBILL NUMBER(8) NOT NULL,
  NUMCLI NUMBER(8) NOT NULL,
  NUMGUARANTEE NUMBER(8) NOT NULL,
  CUSERCRE VARCHAR2(32) NOT NULL,
  ...
  CUSERMOD VARCHAR2(32),
  MODIFDATE DATE,
  CONSTRAINT CPTBILLLEADER_PK PRIMARY KEY (NUMBILLLEADER)
);

CREATE SEQUENCE NUMBILLLEADER_SEQ
START WITH     1
INCREMENT BY   1
NOCACHE
NOCYCLE;

drop table CPT_BILLBROKER cascade constraint ;

CREATE TABLE CPT_BILLBROKER
( 
  NUMBILLBROKER NUMBER(8) NOT NULL,
  NUMBILL NUMBER(8) NOT NULL,
  NUMCLI NUMBER(8) NOT NULL,
  NUMGUARANTEE NUMBER(8) NOT NULL,
  CUSERCRE VARCHAR2(32) NOT NULL,
  ...
  CUSERMOD VARCHAR2(32),
  MODIFDATE DATE,
  CONSTRAINT CPTBILLBROKER_PK PRIMARY KEY (NUMBILLBROKER)
);

CREATE SEQUENCE NUMBILLBROKER_SEQ
START WITH     1
INCREMENT BY   1
NOCACHE
NOCYCLE;

drop table CPT_BILLCOINSURANCE cascade constraint ;

CREATE TABLE CPT_BILLCOINSURANCE
( 
  NUMBILLCOINSURANCE NUMBER(8) NOT NULL,
  NUMBILL NUMBER(8) NOT NULL,
  NUMCLI NUMBER(8) NOT NULL,
  NUMGUARANTEE NUMBER(8) NOT NULL,
  CUSERCRE VARCHAR2(32) NOT NULL,
  ...
  CUSERMOD VARCHAR2(32),
  MODIFDATE DATE,
  CONSTRAINT CPTBILLCOINS_PK PRIMARY KEY (NUMBILLCOINSURANCE)
);

CREATE SEQUENCE NUMBILLCOINSURANCE_SEQ
START WITH     1
INCREMENT BY   1
NOCACHE
NOCYCLE;
...
drop table CPT_BILLPLACEMENT cascade constraint ;

CREATE TABLE CPT_BILLPLACEMENT
( 
  NUMBILLPLACEMENT NUMBER(8) NOT NULL,
  NUMBILL NUMBER(8) NOT NULL,
  NUMCLI NUMBER(8) NOT NULL,
  NUMGUARANTEE NUMBER(8) NOT NULL,
  CUSERCRE VARCHAR2(32) NOT NULL,
  ...
  CUSERMOD VARCHAR2(32),
  MODIFDATE DATE,
  CONSTRAINT CPTBILLPLACEMENT_PK PRIMARY KEY (NUMBILLPLACEMENT)
);

CREATE SEQUENCE NUMBILLPLACEMENT_SEQ
START WITH     1
INCREMENT BY   1
NOCACHE
NOCYCLE;
...
CREATE TABLE CPT_BILLAGENCY
( 
  NUMBILLAGENCY NUMBER(8) NOT NULL,
  NUMBILL NUMBER(8) NOT NULL,
  NUMBILLLEADER NUMBER(8),
  NUMBILLCOINSURANCE NUMBER(8),
  CONSTRAINT CPTBILLAGENCY_PK PRIMARY KEY (NUMBILLAGENCY)
);

CREATE SEQUENCE NUMBILLAGENCY_SEQ
START WITH     1
INCREMENT BY   1
NOCACHE
NOCYCLE;
